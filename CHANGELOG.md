...
- Upgrade Alloy upstream chart from 1.1.0 to 1.1.1
  - This bumps the version of Alloy from 1.9.0 to 1.9.1
...
[Unreleased]: https://github.com/giantswarm/alloy-app/compare/v0.11.0...HEAD
